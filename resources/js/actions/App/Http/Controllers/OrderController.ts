 ...
 * @see app/Http/Controllers/OrderController.php:128
 * @route '/orders/{order}'
 */
 ...
 * @see app/Http/Controllers/OrderController.php:139
 ...
 * @see app/Http/Controllers/OrderController.php:184
 * @route '/orders/{order}'
 */
 ...
 * @see app/Http/Controllers/OrderController.php:190
 ...
 * @see app/Http/Controllers/OrderController.php:201
...
export const getMeasurements = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getMeasurements.url(options),
    method: 'get',
})

getMeasurements.definition = {
    methods: ["get","head"],
...
getMeasurements.url = (options?: RouteQueryOptions) => {
    return getMeasurements.definition.url + queryParams(options)
}
 ...
 */
    const getMeasurementsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: getMeasurements.url(options),
        method: 'get',
    })
